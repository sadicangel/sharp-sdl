...
namespace SharpSDL.Interop
{
    ...
    internal static unsafe partial class SDL2
    {
        ...
        [LibraryImport("SDL2", EntryPoint = "SDL_sscanf")]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial int sscanf([NativeTypeName("const char *")] byte* text, [NativeTypeName("const char *")] byte* fmt);
        ...
        [LibraryImport("SDL2", EntryPoint = "SDL_snprintf")]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial int snprintf([NativeTypeName("char *")] byte* text, [NativeTypeName("size_t")] nuint maxlen, [NativeTypeName("const char *")] byte* fmt);
        ...
        [LibraryImport("SDL2", EntryPoint = "SDL_asprintf")]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial int asprintf([NativeTypeName("char **")] byte** strp, [NativeTypeName("const char *")] byte* fmt);

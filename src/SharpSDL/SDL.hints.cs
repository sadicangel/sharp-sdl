...
internal static partial class SDL
{
    ...
    [LibraryImport(DllName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static unsafe partial byte* SDL_GetHint(byte* name);

    [LibraryImport(DllName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static unsafe partial SDL_bool SDL_SetHint(byte* name, byte* value);

    [LibraryImport(DllName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static unsafe partial SDL_bool SDL_SetHintWithPriority(byte* name, byte* value, SDL_HintPriority priority);

    // 2.0.5 and above.
    [LibraryImport(DllName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static unsafe partial SDL_bool SDL_GetHintBoolean(byte* name, SDL_bool default_value);
}
